...
{ BASS_CTYPE_MUSIC_ADPLUG, "OPL/AdPlug", "*.a2m;*.adl;*.agd;*.amd;*.bam;*.bmf;*.cff;*.cfm;*.cmf;*.d00;*.dfm;*.dmo;*.dro;*.dtm;*.got;*.ha2;*.hsc;*.hsp;*.hsq;*.imf;*.ims;*.ksm;*.laa;*.lds;*.m;*.mad;*.mdi;*.mkj;*.msc;*.mtk;*.mus;*.rad;*.raw;*.rix;*.rol;*.sa2;*.sat;*.sci;*.sdb;*.sng;*.sop;*.sqx;*.vgm;*.xad;*.xms;*.xsm" },
};
