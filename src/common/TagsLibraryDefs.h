//********************************************************************************************************************************
//*                                                                                                                              *
//*     Tags Library 1.0.78.133 © 3delite 2014-2018                                                                              *
...
//#define GETTAGSLIBFUNCTION(f) *(reinterpret_cast<void**>(&f)) = GetProcAddress(TagsLibraryDLLHandle, #f)
#define GETTAGSLIBFUNCTION(f) f = reinterpret_cast<decltype(f)>(GetProcAddress(TagsLibraryDLLHandle, #f))
...
#define NAME_TagsLibrary_AddCoverArtFromFile    "TagsLibrary_AddCoverArtFromFile"
...
#define NAME_TagsLibrary_GetCoverArtBitmapHandle "TagsLibrary_GetCoverArtBitmapHandle"
#define NAME_TagsLibrary_AddCoverArtFromFileAutomatic "TagsLibrary_AddCoverArtFromFileAutomatic"
...
#define NAME_TagsLibrary_AddCoverArtFromFile    "_TagsLibrary_AddCoverArtFromFile"
...
#define NAME_TagsLibrary_GetCoverArtBitmapHandle "_TagsLibrary_GetCoverArtBitmapHandle"
#define NAME_TagsLibrary_AddCoverArtFromFileAutomatic "_TagsLibrary_AddCoverArtFromFileAutomatic"
#endif
...
#define TAGSLIBRARY_PARSE_COVER_ARTS                                    8
#define TAGSLIBRARY_PARSE_AUDIO_ATTRIBUTES                              9
...
typedef BOOL(TAGSLIBCALL *t_TagsLibrary_AddCoverArtFromFile)(HTAGS Tags, TTagType TagType, LPWSTR FileName, TCoverArtData *CoverArt);
...
typedef BOOL(TAGSLIBCALL *t_TagsLibrary_GetCoverArtBitmapHandle)(HTAGS Tags, TTagType TagType, int Index, TCoverArtData *CoverArt, HANDLE *BitmapHandle, int Width, int Height, BOOL KeepAspectRatio, int Resampler, HANDLE Handle);
typedef int(TAGSLIBCALL *t_TagsLibrary_AddCoverArtFromFileAutomatic)(HTAGS Tags, TTagType TagType, LPWSTR FileName, LPWSTR Name, LPWSTR Description, int CoverType, HANDLE Handle);
...
extern "C" {
	...
	t_TagsLibrary_AddCoverArtFromFile TagsLibrary_AddCoverArtFromFile = NULL;
	...
	t_TagsLibrary_GetCoverArtBitmapHandle TagsLibrary_GetCoverArtBitmapHandle = NULL;
	t_TagsLibrary_AddCoverArtFromFileAutomatic TagsLibrary_AddCoverArtFromFileAutomatic = NULL;
...
{
#ifdef _WIN32
	TagsLibraryDLLHandle = LoadLibrary(TEXT(FILENAME_DLL_TAGS_LIBRARY));
#else //* OSX
	...
	if (NULL != TagsLibraryDLLHandle)
	{
		...
		GETTAGSLIBFUNCTION(TagsLibrary_AddCoverArtFromFile);
		...
		GETTAGSLIBFUNCTION(TagsLibrary_GetCoverArtBitmapHandle);
		GETTAGSLIBFUNCTION(TagsLibrary_AddCoverArtFromFileAutomatic);
		...
		if ((NULL == TagsLibrary_Create)
			...
			|| (NULL == TagsLibrary_AddCoverArtFromFile)
			...
			|| (NULL == TagsLibrary_GetCoverArtBitmapHandle)
			|| (NULL == TagsLibrary_AddCoverArtFromFileAutomatic)
			)
		{
