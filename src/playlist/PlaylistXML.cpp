...
if (e = cur->FirstChildElement("artist")) it.tags["artist"] = e->GetText();
if (e = cur->FirstChildElement("album")) it.tags["album"] = e->GetText();
...
if (!it.tags["artist"].empty()) addSimple(e, "artist", it.tags["artist"].c_str());
if (!it.tags["album"].empty()) addSimple(e, "album", it.tags["album"].c_str());
